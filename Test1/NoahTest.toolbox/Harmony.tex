...
\@x{ {\RECURSIVE} AddMult ( \_ ,\, \_ ,\, \_ )}%
 ...
 \@x{\@s{174.54} \.{\ELSE} [ x \.{\in} ( ( {\DOMAIN} AddMult ( Tail ( var\_tup
 ) ,\, Tail ( val\_tup ) ,\, map ) ) \.{\cup} \{ Head ( var\_tup ) \} )
 \.{\,\backslash\,} \{\@w{FALSE} \} \.{\mapsto} {\IF} x \.{=} Head ( var\_tup
 ) \.{\THEN} Head ( val\_tup ) \.{\ELSE} AddMult ( Tail ( var\_tup ) ,\, Tail
 ( val\_tup ) ,\, map ) [ x ] ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{4.1} \.{\land} CTXBAG \.{=} [ c0 \.{\mapsto} init\_ctx ,\, c1
 \.{\mapsto} new\_ctx ,\, c2 \.{\mapsto} new\_ctx ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Push ( ctx ,\, val ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land}\@s{6.90} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land}\@s{6.90} CTXBAG [ ctx ] . active \.{=} {\TRUE}}%
 \@x{\@s{4.1} \.{\land}\@s{6.90} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang}
 [ ctx ] . pc \.{=} PC \.{+} 1 ,\, {\bang} [ ctx ] . stack \.{=} {\langle}
 val {\rangle} \.{\circ} CTXBAG [ ctx ] . stack ]}%
\@x{\@s{4.1} \.{\land}\@s{6.90} {\UNCHANGED} SHARED}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 thread store
...
\@xx{}%
\@x{ StoreVar ( ctx ,\, var ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . active \.{=} {\TRUE}}%
 \@x{\@s{4.1} \.{\land} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang} [ ctx ]
 . pc \.{=} PC \.{+} 1 ,\, {\bang} [ ctx ] . stack \.{=} Tail ( CTXBAG [ ctx
 ] . stack ) ,\, {\bang} [ ctx ] . vars \.{=} NMap ( var ,\, Head ( CTXBAG [
 ctx ] . stack ) ,\, CTXBAG [ ctx ] . vars ) ]}%
...
\@xx{}%
\@x{ Store ( ctx ,\, var ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . active \.{=} {\TRUE}}%
 \@x{\@s{4.1} \.{\land} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang} [ ctx ]
 . pc \.{=} PC \.{+} 1 ,\, {\bang} [ ctx ] . stack \.{=} Tail ( CTXBAG [ ctx
 ] . stack ) ]}%
 \@x{\@s{4.1} \.{\land} SHARED \.{'}\@s{1.51} \.{=} NMap ( var ,\, Head (
 CTXBAG [ ctx ] . stack ) ,\, SHARED )}%
\@pvspace{8.0pt}%
\@x{ Jump ( ctx ,\, PC ,\, PC\_new ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land}\@s{9.32} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land}\@s{9.32} CTXBAG [ ctx ] . active \.{=} {\TRUE}}%
 \@x{\@s{4.1} \.{\land}\@s{9.32} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang}
 [ ctx ] . pc \.{=} PC\_new ]}%
\@x{\@s{4.1} \.{\land}\@s{9.32} {\UNCHANGED} SHARED}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Load ( ctx ,\, var\_name ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land}\@s{6.40} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land}\@s{6.40} CTXBAG [ ctx ] . active \.{=} {\TRUE}}%
\@x{\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{4.1} \.{\land} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang} [ ctx ]
 . pc \.{=} PC \.{+} 1 ,\, {\bang} [ ctx ] . stack \.{=} {\langle} SHARED [
...
\@xx{}%
\@x{ LoadVar ( ctx ,\, var\_name ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . active \.{=} {\TRUE}}%
 \@x{\@s{4.1} \.{\land} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang} [ ctx ]
 . pc \.{=} PC \.{+} 1 ,\, {\bang} [ ctx ] . stack \.{=} {\langle} CTXBAG [
 ctx ] . vars [ var\_name ] {\rangle} \.{\circ} CTXBAG [ ctx ] . stack ]}%
\@x{\@s{4.1} \.{\land} {\UNCHANGED} SHARED}%
\@pvspace{8.0pt}%
\@x{ Spawn ( ctxa ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctxa ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctxa ] . active \.{=} {\TRUE}}%
\@x{\@s{4.1} \.{\land} \.{\LET} SpStk \.{\defeq} SpawnHead ( ctxa ) \.{\IN}}%
 \@x{\@s{15.21} \.{\LET} ctxb \.{\defeq} {\CHOOSE} x \.{\in} {\DOMAIN} CTXBAG
 \.{:} CTXBAG [ x ] . active \.{=} {\FALSE} \.{\IN}}%
 \@x{\@s{15.21} \.{\land} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang} [ ctxa
 ] . pc \.{=} PC \.{+} 1 ,\, {\bang} [ ctxa ] . stack \.{=} SpawnTail ( ctxa
 ) ,\, {\bang} [ ctxb ] . pc \.{=} Head ( SpStk ) ,\, {\bang} [ ctxb ] .
 stack \.{=} Tail ( SpStk ) ,\, {\bang} [ ctxb ] . active \.{=} {\TRUE} ,\,
 {\bang} [ ctxb ] . spn \.{=} {\TRUE} ]}%
\@x{\@s{4.1} \.{\land} {\UNCHANGED} SHARED}%
\@pvspace{8.0pt}%
\@x{\@s{4.1}}%
...
\@xx{}%
\@x{ DelVar ( ctx ,\, var ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . active \.{=} {\TRUE}}%
 \@x{\@s{4.1} \.{\land} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang} [ ctx ]
 . pc \.{=} PC \.{+} 1 ,\, {\bang} [ ctx ] . vars \.{=} NMap2 ( var ,\,
 CTXBAG [ ctx ] . vars ) ]}%
\@x{\@s{4.1} \.{\land} {\UNCHANGED} SHARED}%
\@pvspace{8.0pt}%
\@x{}%
...
\@xx{}%
\@x{ Frame ( ctx ,\, args ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . active \.{=} {\TRUE}}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . spn \.{=} {\TRUE}}%
 \@x{\@s{4.1} \.{\land} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang} [ ctx ]
 . pc \.{=} PC \.{+} 1 ,\, {\bang} [ ctx ] . stack \.{=} Tail ( CTXBAG [ ctx
 ] . stack ) ,\, {\bang} [ ctx ] . vars \.{=} AddMult ( args ,\, CTXBAG [ ctx
 ] . stack ,\, CTXBAG [ ctx ] . vars ) ]}%
\@x{\@s{4.1} \.{\land} {\UNCHANGED} SHARED}%
\@pvspace{8.0pt}%
\@x{ Return ( ctx ,\, PC ) \.{\defeq}}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . pc \.{=} PC}%
\@x{\@s{4.1} \.{\land} CTXBAG [ ctx ] . active\@s{1.69} \.{=} {\TRUE}}%
\@x{\@s{4.1} \.{\land} {\IF} CTXBAG [ ctx ] . spn \.{=} {\TRUE} \.{\THEN}}%
 \@x{\@s{15.21} \.{\land}\@s{1.04} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT}
 {\bang} [ ctx ] . active \.{=} {\FALSE} ]}%
\@x{\@s{15.21} \.{\ELSE}}%
 \@x{\@s{15.21} \.{\land} CTXBAG \.{'} \.{=} [ CTXBAG {\EXCEPT} {\bang} [ ctx
 ] . pc \.{=} Head ( CTXBAG [ ctx ] . stack ) ,\, {\bang} [ ctx ] . stack
 \.{=} Tail ( CTXBAG [ ctx ] . stack ) ]}%
\@x{\@s{4.1} \.{\land} {\UNCHANGED} SHARED}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Nov} 29 22:36:38 \ensuremath{EST} 2021 by \ensuremath{noah
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
